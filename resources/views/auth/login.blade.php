                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        ...
                        <form class="form w-100" id="kt_sign_in_form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="text-center mb-10">
                                <!--begin::Title-->
                                <h1 class="text-dark mb-4">Sign In to {{$settings->title}}</h1>
                                <!--end::Title-->
                                <!--begin::Link-->
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <!--end::Wrapper-->
                                <!--begin::Input-->
                                <input id="password-field" type="password" name="password" required autocomplete="current-password" placeholder="123456789" value="seoera123" class=" @error('password') is-invalid @enderror form-control form-control-lg form-control-solid " autocomplete="off" />
