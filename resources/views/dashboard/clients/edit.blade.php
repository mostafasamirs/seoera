            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h4 class="d-flex align-items-center text-muted  fw-bolder fs-6 my-1">{{ __('Clients') }}
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <h3 class="text-dark fs-5 fw-bold my-1 ms-1">{{ __('Update Client') }}
                            ({{ $client->name }})
                        </h3>
                        <!--end::Description-->
                    </h4>
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">{{ __('Update Client') }}</span>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 fv-row form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        placeholder="{{ __('Name') }}" value="{{ $client->name }}" name="name" maxlength="255"
                                        id="name" required />
                                    @error('name')
                                        <script>
                                ...
                                <div class="col-md-6 fv-row form-group">
                                    ...
                                    <select class="form-control form-control-solid form-select form-select-solid selectd" tabindex="-1" aria-hidden="true" name="language_id" id="language" data-placeholder="{{__('Languages')}}" maxlength="255" required>
                                        ...
                                        <option value="{{ $language->id }}" {{ $client->language_id == $language->id ? 'selected' : '' }} >
                                            {{ $language->title }}
                                        </option>
                                       @endforeach
                                ...
                                <div class="col-md-6 fv-row form-group">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        placeholder="{{ __('Address') }}" value="{{ $client->address }}" name="address" maxlength="255"
                                        id="address" />
                                    @error('address')
                                        <script>
