...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <h4 class="d-flex align-items-center text-muted  fw-bolder fs-6 my-1">{{__('Products')}}
                    ...
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <h3 class="text-dark fs-5 fw-bold my-1 ms-1">{{__('Create Product')}}</h3>
                    <!--end::Description-->
                </h4>
                <!--end::Title-->
            </div>
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-body py-3">
            ...
            <!--begin::Form-->
            <form class="form" action="{{route('products.store')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('POST')
                    ...
                    <div class="me-n7 pe-7" data-kt-scroll-max-height="auto">
                        <div class="row mb-4">
                         ...
                         <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="{{__('Name')}}" value="{{old('name')}}" name="name" id="name" maxlength="255" required autofocus />
                                @error('name')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <select class="form-control form-control-solid form-select form-select-solid selectd" tabindex="-1" aria-hidden="true" name="language_id"  maxlength="255" id="languages" data-placeholder="{{__('languages')}}" required >
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <select class="form-control form-control-solid form-select form-select-solid selectd" tabindex="-1" aria-hidden="true" name="public_unpublic" maxlength="255" id="public_unpublic" data-placeholder="{{__('Public & Unpublic')}}" required>
                                    ...
                                    <option value="unpublic">{{__('Unpublic')}}</option>
                                </select>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="number" class="form-control form-control-solid" placeholder="{{__('salary')}}" value="{{old('salary')}}" name="salary" maxlength="50" id="salary" min="0" step="any" required />
                                @error('salary')
                                <script>
                            ...
                            <div class="col-md-6 fv-row form-group">
                                ...
                                <input type="number" class="form-control form-control-solid" placeholder="{{__('discount')}}" value="{{old('discount')}}" maxlength="50" name="discount" id="discount" min="0" step="any" required />
                                @error('discount')
                                <script>
                            ...
                            <div class="col-md-12 fv-row form-group">
                                <!--begin::Input-->
                                <label for="description" class="fs-5 fw-bold mb-2">{{__('Description')}}</label>
                                <textarea type="text" class="form-control form-control-solid tinymce-editor" placeholder="{{__('Description')}}" value="{{old('description')}}" name="description" id="description" autofocus ></textarea>
                                @error('description')
                                <script>
