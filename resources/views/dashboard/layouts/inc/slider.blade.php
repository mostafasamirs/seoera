				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
				    ...
				    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
				        ...
				        <a href="{{route('admin.home')}}">
				            <img alt="Logo" src="{{asset($settings->logo )}}" class="h-25px logo" style="transform: scale(6.5)!important;    margin: 0 0 0 26px!important;" />
				        </a>
				        @else
				        <a href="{{route('admin.home')}}">
				            <img alt="Logo" src="{{asset('images')}}/logo.png" class="h-25px logo" style="transform: scale(6.5)!important;    margin: 0 0 0 26px!important;" />
				        </a>
				        @endif
				        <!--end::Logo-->
				        <!--begin::Aside toggler-->
				            ...
				            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
				                ...
				                <div class="menu-item">
				                    <div class="menu-content pt-8 pb-2">
				                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">{{__('Languages')}}</span>
				                    </div>
				                </div>
				                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/languages*')) ? 'hover show' : '' }}">
				                    ...
				                    <div class="menu-sub menu-sub-accordion menu-active-bg">
				                        ...
				                        <div class="menu-item">
				                            <a class="menu-link {{ (request()->is('admin/languages')) ? 'active' : '' }}" href="{{route('languages.index')}}">
				                        ...
				                        <div class="menu-item">
				                            <a class="menu-link {{ (request()->is('admin/languages/create')) ? 'active' : '' }}" href="{{route('languages.create')}}">
				                                <span class="menu-bullet">
				                                    <span class="bullet bullet-dot"></span>
				                                </span>
				                                <span class="menu-title">{{__('Create Language')}}</span>
				                            </a>
				                        </div>
				                ...
				                <div class="menu-item">
				                    <div class="menu-content pt-8 pb-2">
				                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">{{__('Admin')}}</span>
				                    </div>
				                </div>
				                ...
				                <div data-kt-menu-trigger="click" class="menu-item menu-accordion  {{ (request()->is('admin/products*')) ? 'hover show' : '' }}">
				                    ...
				                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        ...
                                        <div class="menu-item">
				                            <a class="menu-link {{ (request()->is('admin/products/create')) ? 'active' : '' }}" href="{{route('products.create')}}">
				                                <span class="menu-bullet">
				                                    <span class="bullet bullet-dot"></span>
				                                </span>
